...
const (
	...
	newProductionGolden           = "db7794eced282b514bc17e311f8b6e516e3a79738b5b7e01549b85e025f87388"
	immediateRejectedPredecessor  = "6ce8285f09ce68aa1cb2efe4061178b99ba26e35"
)
...
func buildProductIdentityMigration(t *testing.T) productIdentityMigration {
	...
	return productIdentityMigration{
		...
		SourceRotations: []identityRotation{
			...
			{Field: "cmd/dota2-ob/broadcast_runtime_v3.go", Old: "811f55a7b63ae532a3738702ee664694bb9b1aa0aeefe04792e6f5efe29a3173", New: productRuntimeV3SourceSHA256, Cause: "startup restore completion now publishes a causal readiness signal"},
		},
		DerivedRotations: []identityRotation{
			...
			{Field: "snapshot_v2.sample_lineage", Old: oldV2SampleLineage, New: "7a73872f7476ea20e43804bfd441cb93cf4c4fa99c014860b7dd0af07a3e3725", Cause: "transitive V2 EngineBuild rotation"},
			{Field: "snapshot_v2.sample_durable_commit_1", Old: "2d744a1c4490cddfe3e55112f265df2c89e449694e3336318477989abb2d7927", New: "f98a1fb81838492ee516940e94d4b15a1d57a8ff716dd415890fb660e51514e2", Cause: "transitive V2 lineage rotation"},
			{Field: "snapshot_v2.sample_durable_commit_2", Old: "6111f75a1cd19c3772c5f0b4f9c4e43f4e6091146130686628fd5564367f5666", New: "9eb044fb3ea3f44c0a8aec8c91b0f3f0871b65ce8e11d645c85944d83fc4b239", Cause: "transitive V2 lineage rotation"},
		...
		SuccessorRotations: []identityRotation{
			{Field: "cmd/dota2-ob/product_selector.go", Old: "dba26a22bdc96d5f47d4c4d18afaa9694166f85d491f73266a723de5f09ab284", New: productSelectorSourceSHA256, Cause: "selector parity with Go flag parsing"},
			...
			{Field: "cmd/dota2-ob/broadcast_runtime_v3.go", Old: "811f55a7b63ae532a3738702ee664694bb9b1aa0aeefe04792e6f5efe29a3173", New: productRuntimeV3SourceSHA256, Cause: "causal restore readiness signal"},
			{Field: "snapshot_v2.engine_build", Old: "61746bc2646361125ff75824018b67290da62d6ff0653c9e1e1f850056a46e96", New: expectedProductLineageArtifacts().engineBuild.ContentSHA256, Cause: "transitive selector rotation"},
			...
			{Field: "live_only_v3.engine_build", Old: "71b911ab473bbba9f334c6e2d23b438d9203d960c0441d1ba0408ed7ec3bd2aa", New: current.Lineage.EngineBuild.ContentSHA256, Cause: "selector, current parser consumer, and restore readiness rotations"},
			{Field: "m4_fixture.lineage_manifest", Old: "afd756eb475a23eb8bdf27c7e1a302e8adfac4efeb6d7cfd3f432c9454c68a46", New: newLineageID, Cause: "transitive V3 EngineBuild rotation"},
			{Field: "m4_fixture.release_binding", Old: "463943630328251da753a103531ec6ac3cf4ffbc19a23897f50e7f3332a37f48", New: newReleaseID, Cause: "transitive V3 lineage rotation"},
			{Field: "m4.production_golden", Old: "91cb288bec4048f6ae1e6497a433fc0e4c9b4041d5f289f65945ca365cb3d67c", New: newProductionGolden, Cause: "terminal commits contain the rotated V3 lineage identity"},
		},
