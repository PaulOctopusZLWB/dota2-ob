...
func expectedProductLineageArtifacts() productLineageArtifacts {
	catalog, terminology, localization, engine, err := snapshotv2.Artifacts(insight.RulesArtifact().ContentSHA256)
	if err != nil {
		panic(err)
	}
	return productLineageArtifacts{
		...
		localizationMapping: localization,
		engineBuild:         engine,
	}
}
...
func expectedProductLineageArtifactsV3() productLineageArtifacts {
	return productLineageArtifacts{
		...
		engineBuild: sourceArtifact("dota2-ob.product.v3", productSelectorSourceSHA256, productMainSourceSHA256, productPortsSourceSHA256,
