...
func TestRehearsalSuccessorArtifactsRotateWithoutChangingP4Artifacts(t *testing.T) {
	...
	if successor.EngineBuild.ContentSHA256 != "4a3b6d69b8966b76055656338a751502aac28e50bc0f7c0fe3012359af0d338c" || successor.MustContentID() != "e9b4dc62190018971620e2115478bb517408538ea8faf784247bae6cdf0a53ba" || successorRelease != "65f416712979d3b5c8411a78115a70547c97d819e0b7e7e0b218d92a45b9f9c0" {
...
func TestRehearsalAttemptRejectsAdjacentSequenceIdentityDriftThenRestore(t *testing.T) {
	...
	observed := []RehearsalDotaIdentityV1{bound, bound, drift, bound}
	index := 0
	result, err := RehearsalAttempt(context.Background(), RehearsalAttemptConfig{DataRoot: root, RepoRoot: repo, identity: func() (RehearsalDotaIdentityV1, error) {
	...
	if terminal.RawAdmission.AcceptedRecords != 1 || terminal.RawAdmission.Failure.Primary != "record_admission_guard_failure" || len(terminal.Process) != 4 || terminal.Process[2].RawSequence != 2 {
